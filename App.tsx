    ...
    const SessionView = () => (
        <div className="relative z-10 flex flex-col h-screen">
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative p-6">
                ...
                <div className="absolute bottom-48 left-0 right-0 z-20 flex justify-center pointer-events-none">
                    <VoiceWaveform
                        audioLevel={audioLevel > 0.01 ? audioLevel : 0.2} // Show gentle idle wave
                        isActive={true}
                        type="organic"
                        color="rgba(34, 211, 238, 0.8)" // Cyan base
                        smoothing={0.9}
                        height={100}
                        width="100%"
                    />
                ...
                <div className="h-64 overflow-y-auto pr-4 mb-8 space-y-4 scrollbar-hide">
                    {transcript.length > 0 ? transcript.map((turn, i) => (
                        <div key={i} className={`flex ${turn.role === 'assistant' ? 'justify-start' : 'justify-end'}`}>
                            <div className={`max-w-[80%] p-3 rounded-lg text-sm leading-relaxed ${turn.role === 'assistant'
